 ...
 * Only Linux is supported (arm64, x64).
 */
export function getBinaryName() {
  ...
  if (platform === "linux") {
    ...
    return `rush-cache-server-${os.arch()}`;
  }
...
export const LOGS_DIR = path.resolve(os.tmpdir(), "rush_cache_logs");
export const SERVER_PID_KEY = "RUSH_CACHE_SERVER_PID";
