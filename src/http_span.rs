...
use crate::routes::health_check::HEALTH_CHECK_PATH;
...
/// via the env filter (e.g. `RUST_LOG=info,rush_cache_server::routes::health_check=off`).
pub struct RushRootSpanBuilder;

impl RootSpanBuilder for RushRootSpanBuilder {
